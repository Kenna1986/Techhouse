...
/*
	...
	Plugin URI: http://github.com/johanson/slideshow
	Description: Slideshow Manager for Wordpress
	Author: Rasmus Johanson
	Version: 2.1.1
	Author URI: http://github.com/johanson
	License: GPLv2
...
function update_callback() {
	global $wpdb, $table_name;
	$data = $_POST['id'];
	$wpdb->update($table_name, array('description' => $data[1], 'link' => $data[2]), array('id' => $data[0]));
	print_r($data);
	die();
}
